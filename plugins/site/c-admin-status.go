...
func (p *Plugin) _osStatus() (h2o.H, error) {
...
func (p *Plugin) _networkStatus() (h2o.H, error) {
	sts := h2o.H{}
...
func (p *Plugin) _dbStatus() (h2o.H, error) {
	val := h2o.H{
		"drivers": sql.Drivers(),
	}
...
func (p *Plugin) _routes() []h2o.H {
	...
	var items []h2o.H
	rt.Walk(func(method string, path string, handlers ...h2o.HandlerFunc) error {
		items = append(items, h2o.H{"method": method, "path": path})
		return nil
	})
	return items
}
...
func (p *Plugin) getAdminSiteStatus(c *h2o.Context) error {
	data := h2o.H{}
