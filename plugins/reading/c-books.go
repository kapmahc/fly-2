...
func (p *Plugin) indexBooks(c *h2o.Context) error {
...
func (p *Plugin) showBook(c *h2o.Context) error {
	data := h2o.H{}
...
func (p *Plugin) showPage(c *h2o.Context) error {
...
func (p *Plugin) destroyBook(c *h2o.Context) error {
	if err := p.Db.
		Where("id = ?", c.Param("id")).
